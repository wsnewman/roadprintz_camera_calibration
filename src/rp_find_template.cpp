// code started from gui calibration test pgm; extend to 
//  interpretation of checkerboard template
...
vertex.y = 74;   */
   ...
   lowThreshold=max_lowThreshold; //wsn override slider
    ...
    if (g_click_num==2) {
        g_x0 = 306; //approx soln for image17_rect.jpg
        g_y0 = 200;
        g_x1 = 417;
        g_y1 = 368;
        int x_start = g_x0;
